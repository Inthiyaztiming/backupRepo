...
//------------------------------CACHE----------------------------
//Cache (pronounced "cash") refers to a temporary storage area used by web browsers and apps to store copies of files, images, JavaScript, and 
//other resources that are frequently accessed by a website or application. Its purpose is to speed up loading times and reduce bandwidth 
//usage by reusing previously downloaded resources.
