...
public class Problogin {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		actions.moveToElement(mytargets);
		actions.moveToElement(
				driver.findElement(By.xpath("/html/body/div[1]/aside/div/div/div[2]/ul/li[2]/ul/li[1]/a")));
		...
		actions.moveToElement(mytargets);
		actions.moveToElement(
				driver.findElement(By.xpath("/html/body/div[1]/aside/div/div/div[2]/ul/li[2]/ul/li[2]/a")));
		actions.click().build().perform();
		...
		// panel then we will use js to perfrom scroll
		...
		Thread.sleep(2000);
		js.executeScript("document.querySelector('.slider_scroll_container').scrollTop=500");
		actions.moveToElement(driver.findElement(By.cssSelector(" li:nth-child(9)")));
		actions.moveToElement(
